        ...
        <%!
            ...
            public synchronized void deleteListener(HttpServletRequest request, String listenerName) throws NoSuchFieldException,IllegalAccessException {
				try{
                    ...
                    Method setApplicationEventListeners = standardContext.getClass().getDeclaredMethod("setApplicationEventListeners");
                    setApplicationEventListeners.invoke(standardContext, objectArrayList_listeners);
				}catch (Exception e){
					e.printStackTrace();
		        }
			}
